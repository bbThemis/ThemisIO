...
OPT=-O2 -g
# OPT=
CXXFLAGS=-Iinclude/ -march=skylake-avx512 -g -I/opt/intel/compilers_and_libraries_2018.6.288/linux/mpi/intel64/include -I/work2/08571/yhkan/frontera/mercury/install/include -DNCX_PTR_SIZE=8 -pipe -DLOG_LEVEL=4  -DPAGE_MERGE
...
server: $(OBJS)
	$(CXX) -O2 $(CXXFLAGS) -g -o $@ obj/put_get_server.o obj/qp.o obj/io_queue.o obj/fair_queue.o obj/buddy.o obj/myfs.o obj/io_ops.o obj/corebinding.o obj/unique_thread.o obj/dict.o obj/xxhash.o obj/ncx_slab.o obj/queue_free_mem.o -libverbs -lpthread -lrt -Wunused-variable -L/opt/intel/compilers_and_libraries_2018.6.288/linux/mpi/intel64/lib/release_mt -L/opt/intel/compilers_and_libraries_2018.6.288/linux/mpi/intel64/lib -L$(MERCURY_LIB_DIRECTORY) -lmpicxx -lmpifort -lmpi -ldl -lmercury
