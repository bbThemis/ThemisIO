...
OPT=-O2 -g
# OPT=
CXXFLAGS=-Iinclude/ -march=skylake-avx512 -g -I$(TACC_IMPI_INC) -I$(UCX_INCLUDE_DIRECTORY)  -DNCX_PTR_SIZE=8 -pipe -DLOG_LEVEL=4  -DPAGE_MERGE
OBJS=obj/put_get_server.o obj/qp.o obj/dict.o obj/xxhash.o obj/io_queue.o obj/myfs.o obj/io_ops.o obj/buddy.o obj/ncx_slab.o obj/corebinding.o obj/unique_thread.o obj/queue_free_mem.o obj/fair_queue.o obj/ucx_rma.o obj/ucx_rma_common.o
...
HEADERS=include/dict.h include/qp_common.h include/qp.h include/io_queue.h include/utility.h include/xxhash.h include/list.h include/buddy.h include/myfs.h include/io_ops_common.h include/io_ops.h include/corebinding.h include/unique_thread.h include/ncx_slab.h include/ncx_core.h include/ncx_log.h include/queue_free_mem.h include/fixed_mem_allocator.h include/fair_queue.h include/ucx_rma.h include/ucx_rma_common.h
RM=rm -rf
...
server: $(OBJS)
	$(CXX) -O2 $(CXXFLAGS) -g -o $@ obj/put_get_server.o obj/qp.o obj/io_queue.o obj/fair_queue.o obj/ucx_rma.o obj/ucx_rma_common.o obj/buddy.o obj/myfs.o obj/io_ops.o obj/corebinding.o obj/unique_thread.o obj/dict.o obj/xxhash.o obj/ncx_slab.o obj/queue_free_mem.o -libverbs -lpthread -lrt -Wunused-variable -L$(TACC_IMPI_LIB)/release_mt -L$(TACC_IMPI_LIB)  -L$(UCX_LIB_DIRECTORY) -lmpicxx -lmpifort -lmpi -ldl -lucp -lucm -lucs -luct
...
obj/ucx_rma_common.o: src/ucx_rma_common.cpp $(HEADERS)
	$(CXX) $(OPT) $(CXXFLAGS) -c -o obj/ucx_rma_common.o  $<
